...
public class badgeViewPlus extends FrameLayout implements iBadgeViewPlus {
    //region Properties
    ...
    public badgeViewPlus(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.layout_image_bagde_plus, this, true);
    ...
    public badgeViewPlus(Context context) {
        this(context, null);
    }
    ...
    @Override
    public badgeViewPlus src(int picture, ImageView.ScaleType scaleType) {
        setSrc(picture);
